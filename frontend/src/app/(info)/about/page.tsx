...
export const metadata: Metadata = {
	...
	description:
		'M-in-M — це більше, ніж продукція для манікюру. Це перевірений інструмент, який дозволяє творити з упевненістю, досягати професійного результату з легкістю та задоволенням. З 2013 року наш бренд представляє в Україні польську професійну косметику для нігтьового сервісу. За понад десятиліття ми стали надійним партнером для майстрів.',
	openGraph: {
		title: 'Про нас | M in M',
		description:
			'M-in-M — це більше, ніж продукція для манікюру. Це перевірений інструмент, який дозволяє творити з упевненістю, досягати професійного результату з легкістю та задоволенням. З 2013 року наш бренд представляє в Україні польську професійну косметику для нігтьового сервісу. За понад десятиліття ми стали надійним партнером для майстрів.',
